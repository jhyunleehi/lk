...
* 이렇게 하면 cross compile 되기는한데.. gdb 다시 만들어야 하기 때문에 그냥 Linaro 다운 받아서 설치하는 것이 편한다.
...
```
./arch/arm/configs/bcm2709_defconfig     <<--- config 
./arch/arm/boot/dts/bcm2710-rpi-3-b.dts  <<--- device
...
![img](D:\Code\lk\16.커널의 구조와 원리\img\compile.jpg)
